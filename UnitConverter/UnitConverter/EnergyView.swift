...
struct EnergyView: View {
    ...
    @State private var unitOne: UnitEnergy = .baseUnit()
    @State private var valueTwo = 0.0
    @State private var unitTwo: UnitEnergy = .baseUnit()
    
    let options: [UnitEnergy] = [.kilojoules, .joules, .kilocalories, .calories, .kilowattHours]
