...
struct IlluminanceView: View {
    
    @State private var valueOne = 0.0
    @State private var unitOne: UnitIlluminance = .baseUnit()
    @State private var valueTwo = 0.0
    @State private var unitTwo: UnitIlluminance = .baseUnit()
    
    let options: [UnitIlluminance] = [.lux]
...
struct IlluminanceView_Previews: PreviewProvider {
