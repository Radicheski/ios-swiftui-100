...
struct TemperatureView: View {
    ...
    @State private var unitOne: UnitTemperature = .baseUnit()
    @State private var valueTwo = 0.0
    @State private var unitTwo: UnitTemperature = .baseUnit()
    
    let options: [UnitTemperature] = [.kelvin, .celsius, .fahrenheit]
