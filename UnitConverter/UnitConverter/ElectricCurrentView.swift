...
struct ElectricCurrentView: View {
    ...
    @State private var unitOne: UnitElectricCurrent = .baseUnit()
    @State private var valueTwo = 0.0
    @State private var unitTwo: UnitElectricCurrent = .baseUnit()
    
    let options: [UnitElectricCurrent] = [.megaamperes, .kiloamperes, .amperes,
                                          .milliamperes, .microamperes]
...
struct ElectricCurrentView_Previews: PreviewProvider {
