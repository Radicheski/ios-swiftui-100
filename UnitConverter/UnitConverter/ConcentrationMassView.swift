...
struct ConcentrationMassView: View {
    
    @State private var valueOne = 0.0
    @State private var unitOne: UnitConcentrationMass = .baseUnit()
    @State private var valueTwo = 0.0
    @State private var unitTwo: UnitConcentrationMass = .baseUnit()
    
    let options: [UnitConcentrationMass] = [.gramsPerLiter, .milligramsPerDeciliter]
...
struct ConcentrationMassView_Previews: PreviewProvider {
    static var previews: some View {
        ConcentrationMassView()
    }
}
