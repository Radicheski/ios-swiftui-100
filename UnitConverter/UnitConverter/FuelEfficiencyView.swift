...
struct FuelEfficiencyView: View {
    ...
    @State private var unitOne: UnitFuelEfficiency = .baseUnit()
    @State private var valueTwo = 0.0
    @State private var unitTwo: UnitFuelEfficiency = .baseUnit()
    
    let options: [UnitFuelEfficiency] = [.litersPer100Kilometers, .milesPerGallon,
