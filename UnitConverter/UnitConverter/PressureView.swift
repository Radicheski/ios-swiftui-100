...
struct PressureView: View {
    ...
    @State private var unitOne: UnitPressure = .baseUnit()
    @State private var valueTwo = 0.0
    @State private var unitTwo: UnitPressure = .baseUnit()
    
    let options: [UnitPressure] = [.newtonsPerMetersSquared, .gigapascals, .megapascals,
                                   .kilopascals, .hectopascals, .inchesOfMercury, .bars,
                                   .millibars, .millimetersOfMercury, .poundsForcePerSquareInch]
