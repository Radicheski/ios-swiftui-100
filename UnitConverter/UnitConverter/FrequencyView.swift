...
struct FrequencyView: View {
    ...
    @State private var unitOne: UnitFrequency = .baseUnit()
    @State private var valueTwo = 0.0
    @State private var unitTwo: UnitFrequency = .baseUnit()
    
    let options: [UnitFrequency] = [.terahertz, .gigahertz, .megahertz, .kilohertz, .hertz,
                                    .millihertz, .microhertz, .nanohertz]
