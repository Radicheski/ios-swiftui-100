...
struct SpeedView: View {
    ...
    @State private var unitOne: UnitSpeed = .baseUnit()
    @State private var valueTwo = 0.0
    @State private var unitTwo: UnitSpeed = .baseUnit()
    
    let options: [UnitSpeed] = [.metersPerSecond, .kilometersPerHour, .milesPerHour, .knots]
