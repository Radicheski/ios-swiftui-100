...
struct ElectricResistanceView: View {
    ...
    @State private var unitOne: UnitElectricResistance = .baseUnit()
    @State private var valueTwo = 0.0
    @State private var unitTwo: UnitElectricResistance = .baseUnit()
    
    let options: [UnitElectricResistance] = [.megaohms, .kiloohms, .ohms,
                                             .milliohms, .microohms]
...
struct ElectricResistanceView_Previews: PreviewProvider {
    static var previews: some View {
        ElectricResistanceView()
    }
}
