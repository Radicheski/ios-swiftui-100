...
struct DispersitionView: View {
    
    @State private var valueOne = 0.0
    @State private var unitOne: UnitDispersion = .baseUnit()
    @State private var valueTwo = 0.0
    @State private var unitTwo: UnitDispersion = .baseUnit()
    
    let options: [UnitDispersion] = [.partsPerMillion]
...
struct DispersitionView_Previews: PreviewProvider {
