...
struct PowerView: View {
    ...
    @State private var unitOne: UnitPower = .baseUnit()
    @State private var valueTwo = 0.0
    @State private var unitTwo: UnitPower = .baseUnit()
    
    let options: [UnitPower] = [.terawatts, .gigawatts, .megawatts, .kilowatts, .watts,
                                .milliwatts, .microwatts, .nanowatts, .picowatts, .femtowatts,
                                .horsepower]
