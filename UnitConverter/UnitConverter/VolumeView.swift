...
struct VolumeView: View {
    ...
    @State private var unitOne: UnitVolume = .baseUnit()
    @State private var valueTwo = 0.0
    @State private var unitTwo: UnitVolume = .baseUnit()
    
    let options: [UnitVolume] = [.megaliters, .kiloliters, .liters, .deciliters, .centiliters,
                                 .milliliters, .cubicKilometers, .cubicMeters, .cubicDecimeters,
                                 .cubicMillimeters, .cubicInches, .cubicFeet, .cubicYards,
                                 .cubicMiles, .acreFeet, .bushels, .teaspoons, .tablespoons,
                                 .fluidOunces, .cups, .pints, .quarts, .gallons,
