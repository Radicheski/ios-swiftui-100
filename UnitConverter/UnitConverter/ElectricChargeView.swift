...
struct ElectricChargeView: View {
    ...
    @State private var unitOne: UnitElectricCharge = .baseUnit()
    @State private var valueTwo = 0.0
    @State private var unitTwo: UnitElectricCharge = .baseUnit()
    
    let options: [UnitElectricCharge] = [.coulombs, .megaampereHours, .kiloampereHours,
                                         .ampereHours, .milliampereHours, .microampereHours]
...
struct ElectricChargeView_Previews: PreviewProvider {
