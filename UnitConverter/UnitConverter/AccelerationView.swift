...
struct AccelerationView: View {
    ...
    @State private var unitOne: UnitAcceleration = .baseUnit()
    @State private var valueTwo = 0.0
    @State private var unitTwo: UnitAcceleration = .baseUnit()
    
    let options: [UnitAcceleration] = [.gravity, .metersPerSecondSquared]
